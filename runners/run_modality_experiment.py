#!/usr/bin/env python3
"""
Run EXP1: Modality Tests

Compares different input modality configurations:
- Accelerometer only (3ch, 4ch with SMV)
- Accelerometer + Gyroscope (6ch, 7ch)
- With/without SE+TAP attention

Usage:
    python -m runners.run_modality_experiment [--device 0] [--results-dir results]
"""
...
def main():
    parser = argparse.ArgumentParser(description='Run EXP1: Modality Tests')
