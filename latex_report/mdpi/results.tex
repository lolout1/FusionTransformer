...
Our dual-stream Kalman transformer achieves +3.3\% F1 improvement over the prior best result on SmartFallMM (91.10\% vs. 87.8\%). Notably, our evaluation uses stricter 21-fold LOSO-CV, which better reflects real-world generalization to unseen individuals compared to random window splits or k-fold CV that may leak subject-specific patterns.
