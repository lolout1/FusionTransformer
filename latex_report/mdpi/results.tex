...
\textbf{Accuracy vs. F1 tradeoff.} Our model achieves lower accuracy (87.30\%) than some prior methods despite higher F1. This reflects our optimization objective: Focal Loss prioritizes fall detection (minority class) over overall accuracy. The stricter LOSO protocol also contributes---random splits in prior work may inflate accuracy through subject-specific pattern leakage. For fall detection applications, optimizing sensitivity (recall) is more critical than overall accuracy, as missed falls have severe consequences.
