...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{f1_bar_comparison.png}
\caption{F1 score comparison across architectures. Dual-stream Kalman transformer achieves the highest performance (91.10\%), outperforming single-stream variants. Error bars indicate standard deviation across 21 LOSO-CV folds.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{training_curves_kalman_comparison.png}
\caption{Training and validation curves comparing Kalman-fused vs. raw input architectures. Kalman-fused models exhibit more stable training dynamics and achieve higher validation F1 scores with smaller generalization gaps.}
\label{fig:training}
\end{figure}
