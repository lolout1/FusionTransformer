...
\textbf{Computational efficiency.} Our model requires 55K parameters and 10.2 ms inference time on representative smartwatch hardware. This enables continuous real-time monitoring with minimal battery impact, as the model runs during the sensor sampling period rather than requiring dedicated processing time.
