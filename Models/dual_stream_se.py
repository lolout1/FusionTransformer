"""
DualStreamSE: Dual-Stream Transformer with SE and Temporal Attention Pooling.

DUAL-STREAM means: Separate projection paths for accelerometer and gyroscope.
...
Renamed from IMUTransformerSE for clarity.
"""
...
class DualStreamSE(nn.Module):
    """Dual-stream transformer with SE and Temporal Attention Pooling."""
...
IMUTransformerSE = DualStreamSE


if __name__ == "__main__":
    print("=" * 60)
    print("DualStreamSE Model Architecture Test")
    print("=" * 60)
    ...
    print("=" * 50)
    model_6ch = DualStreamSE(imu_frames=128, imu_channels=6, embed_dim=64, num_classes=1)
